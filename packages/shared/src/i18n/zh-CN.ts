...
export const zhCNMessages: Partial<Record<MessageKey, string>> = {
  ...
  "chat.composer.placeholder.default": "输入问题，@提及文件/文件夹，$调用技能，或 / 使用命令",
  "chat.composer.placeholder.disconnected": "请求修改、发送追问，或附加图片",
  "chat.composer.placeholder.approval": "解决此审批请求以继续",
  "chat.composer.placeholder.customAnswer": "输入你自己的回答，或留空以使用所选选项",
  "chat.composer.placeholder.planFeedback": "添加反馈以优化计划，或留空以直接实施",
  "chat.composer.placeholder.chooseProject": "在上方选择一个项目以开始会话",
  "chat.composer.placeholder.enableProvider": "在设置中启用提供商后才能发送消息",
